...
<style>
	...
	.About{margin-top: 4rem;background: #fff;}
	.About .about-con {padding: 1rem; width: 100%; margin: 0 auto; box-sizing: border-box;}
	.About .about-con h2{font-size: 1.4rem; margin:0.5rem 0; font-weight: 700;}
	.About .about-con h3{font-size: 1.2rem; line-height: 27px;}
	.About .about-con p{text-indent:1rem; line-height: 17px;}
	.About .table-box{font-size: 1.4rem; width: 100%; height:3rem; line-height:3rem;}
</style>