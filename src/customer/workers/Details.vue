...
<style type="text/css" scoped="scoped">
	.details{margin-top: 4.5rem; position: relative;}
	.details .list{ width:99%; margin:0 auto; box-sizing: border-box; border:1px solid #eee; box-shadow: 0 0 10px 5px #eee; background-color: #fff;}
	.details .list h3{font-size: 1.4rem; color: #00CC66; margin:0.5rem;}
	.details .list p{ padding:0 0.5rem;font-size: 1.2rem; }
	.details .title{background: #00CC66; color: #fff; text-align: center; font-size: 1.4rem; padding: 0.5rem 0;}
	.details .mt-button{margin: 0 auto 1rem;display:block; width: 8rem; font-size: 1.2rem;}
	.details .personal-info{ display: flex;}
	.details .personal-head{ padding: 0 1rem 0 0.5rem;}
	.details .head-info{width:80px; height:80px; background: #eee; border-radius: 5px;}
	.details .detalis-price{font-size: 1.2rem; padding: 0.5rem;}
	.details .detalis-price .red{font-size: 1.4rem;}
	.details .tiem{font-size: 1.4rem; text-align: center; padding: 1rem 0;}
	.details .btn-cancellation{ border: 1px solid #E02828; margin-top: 2rem; width:10rem; background: #fff; color:#E02828;}
	.details .cancellation-button{border: 1px solid #F32043;background:#fff;font-size: 1.2rem; display: block; padding:1rem 0.5rem; color:#F32043; text-align: center; margin: 2rem auto; border-radius:5px; width:10rem;}
</style>