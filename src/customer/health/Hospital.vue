    ...
    methods:{
          areaClick:function(AreaCode,AreaName){
           ...
           go:function(hospitalName,hospitalId){
           	    ...
           	    if(page=="workers"){
           	      util.pushRouter(router,"/customer/workers",{hospitalName:hospitalName,"hospitalId":hospitalId})	
           	    }else{
           	      util.pushRouter(router,"/customer/hospitalWizard",{hospitalName:hospitalName,"hospitalId":hospitalId})	
           	    }
          },
    },mounted:function(){
